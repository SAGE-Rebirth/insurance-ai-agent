...
Real-time, voice-powered AI insurance agent that provides instant policy assistance. Built with **Google's Gemini 2.5 Flash** model using the Multimodal Live API, this application delivers a natural, human-like voice conversation experience.
